...
from utils.sublayers import MultiBranchAttention
from utils.sublayers import PoswiseFeedForwardNet


class EncoderLayer(nn.Module):
    def __init__(self, d_k, d_v, d_model, d_ff, n_heads, dropout=0.01):
...
class WeightedEncoderLayer(nn.Module):
    def __init__(self, d_k, d_v, d_model, d_ff, n_branches, dropout=0.01):
